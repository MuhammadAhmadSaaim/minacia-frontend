                    ...
                    >
                        {!isSearchActive ? (
                            ...
                            <input
                                type="text"
                                placeholder="Search"
                                className="w-2/3 p-2 border border-gray-300 rounded-md focus:outline-none transition-all duration-500 ease-in-out"
                                autoFocus
                            />
                        )}
                    </div>
                    ...
                    <div className="flex items-center space-x-4 ml-auto transition-all duration-700 ease-in-out">
                        ...
                        {!isSearchActive ? (
                            ...
                            <button
                                ...
                                className="text-sm font-semibold cursor-pointer transition-all duration-500"
                            >
                                Close
                            </button>
                        )}
                        <button onClick={handleMenuToggle} className="flex items-center space-x-1 transition-all duration-500">
                            <FiMenu size={20} />
