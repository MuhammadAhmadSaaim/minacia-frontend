        ...
        <div>
            <div className="p-6 max-w-4xl mt-32 mb-10 mx-auto font-cormorant">
                ...
                <p className="mb-4 text-gray-700">
                    Welcome to Minicia. We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href="http://www.minicia.com" className="text-black hover:underline">www.minicia.com</a>, make a purchase, or interact with us in other ways.
                </p>
                <p className="mb-4 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-6 mb-4 text-gray-700">
                    <li><strong>Email</strong>: <a href="mailto:minicia@gmail.com" className="text-black hover:underline">minicia@gmail.com</a></li>
                    <li><strong>Phone</strong>: +1 (123) 456-7890</li>
                    <li><strong>Address</strong>: 123 Fashion Street, Suite 456, Trendy City, CA 90210, USA</li>
                </ul>
                <p className="mb-4 text-gray-700">
                    Thank you for trusting Minicia. We value your privacy and are committed to protecting your personal information.
                </p>
            </div>
        </div>
    );
